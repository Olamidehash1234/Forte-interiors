...
const ContactInfo: React.FC = () => {
  return (
    <div className="bg-[#3B241E] text-white py-[40px] px-[16px] mb-[40px] lg:mb-[60px] lg:px-[80px]">
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        <div className="flex flex-col">
          <h2 className="text-2xl lg:text-[40px] lg:leading-[40px] font-medium uppercase font-bold mb-4 lg:mb-[40px]">
            Contact Information
          </h2>
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-[160px]">
            <div>
              ...
              <ul className="list-disc text-[14px] leading-normal list-inside lg:ml-[8px] text-white text-sm">
